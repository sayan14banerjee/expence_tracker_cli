# 💸 Expense Tracker CLI
Sample solution for the [/expense-tracker](https://github.com/sayan14banerjee/expence_tracker_cli) challenge from [roadmap.sh](https://roadmap.sh/projects/expense-tracker)
